  ...
  return <>
    <section id="home" className="grain relative flex min-h-[720px] items-end overflow-hidden border-b border-white/10 pt-28">
      ...
      <div className="shell relative z-10 pb-16 pt-24 lg:pb-24">
        <Image src="/brand/magic-auto-paint-logo-transparent.png" alt="Magic Auto Paints logo" width={1792} height={878} priority className="mb-8 h-auto w-52 sm:w-72" />
        <h1 className="display-title max-w-5xl text-[clamp(3.3rem,8vw,8rem)]">Welcome to<br/><span className="text-orange-500">Magic Auto Paints</span></h1>
    ...
    <section className="section metal-grid">
      <div className="shell grid items-center gap-14 lg:grid-cols-[.9fr_1.1fr]">
        ...
        <div className="reveal">
          ...
          <h2 className="display-title text-3xl sm:text-5xl">EXPERT BODYWORK REPAIRS WITH A FLAWLESS FINISH</h2>
          <p className="mt-7 text-lg leading-8 text-white/60">Magic Auto Paints is a trusted automotive body repair specialist based in Dorking, Surrey, providing high-quality bodywork solutions for private motorists, fleet operators, and corporate clients. Our fully equipped body shop is capable of handling everything from simple paintless dent removal and minor cosmetic repairs to extensive accident damage and major bodywork restoration.</p>
          <p className="mt-4 text-lg leading-8 text-white/60">With a commitment to exceptional craftsmanship, advanced repair techniques, and outstanding customer service, our experienced team ensures every vehicle is restored to the highest standards—delivering a flawless finish and getting you back on the road with confidence.</p>
        </div>
      </div>
    </section>
    ...
    <section className="section border-y border-white/10 bg-[#0b0b0b]">
      <div className="shell">
        <div className="reveal">
          ...
          <p className="mt-5 text-lg text-white/60">Call <a className="text-orange-400" href={`tel:${business.contactNumberHref}`}>{business.contactNumberDisplay}</a> or email <a className="text-orange-400" href={`mailto:${business.email}`}>{business.email}</a> for a FREE QUOTATION.</p>
