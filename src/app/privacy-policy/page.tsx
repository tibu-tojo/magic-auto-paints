...
export default function PrivacyPolicyPage() {
  return <>
    <PageHero eyebrow="Legal" title="Privacy Policy" description="How Magic Auto Paints Ltd protects and uses the personal data provided to us." />
