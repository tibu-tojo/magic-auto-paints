...
const legalDetails = [
  ["Name of company", "Magic Auto Paint Ltd"],
...
export default function LegalNoticePage() {
  return <>
    <PageHero eyebrow="Legal" title="Legal Notice" description="Registered company and data-controller information for Magic Auto Paint Ltd." />
