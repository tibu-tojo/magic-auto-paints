...
export function PriceListSection() {
  return <section id="price-list" className="section border-y border-white/10 bg-[#0b0b0b]"><div className="shell">
    <div className="reveal"><p className="eyebrow">Price List</p><h2 className="display-title text-4xl sm:text-6xl">Price List</h2><p className="mt-6 max-w-5xl text-lg italic leading-8 text-white/60">All our prices are starting from and they are tailored for every repair dependent on the paint / materials required to the size of the job being taken on, as discounts are available if it is a multi-panel job. This will all be discussed at the free quote / consultation.</p></div>
