...
export function ConsentMap() {
  ...
  if (allowed) return <iframe title="Magic Auto Paints location map" className="h-[420px] w-full border-0 grayscale-[.6]" loading="lazy" referrerPolicy="no-referrer-when-downgrade" src="https://www.google.com/maps?q=Dorking%20West%20Station%20Yard%20RH4%201HW&output=embed" />;
